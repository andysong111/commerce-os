...
test("the worker falls back once from long ranges to 30 days and then to 7 days", () => {
  assert.match(
    route,
...
test("a failed 7-day run stops instead of creating an infinite retry loop", () => {
