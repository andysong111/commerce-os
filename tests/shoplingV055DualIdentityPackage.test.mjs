...
test("Shopling v0.5.6+ downloadable package requires goods key plus self-code exact identity", async () => {
  ...
  assert.match(source, /manifest\.version = "0\.5\.[6789]"/);
...
test("Shopling v0.5.6+ package carries the field-verified category mapping controls", async () => {
  ...
  assert.match(source, /commerce-os-shopling-account-title-bridge-v0\.5\.[6789]\.zip/);
  assert.match(source, /Commerce OS Shopling Account Title Bridge v0\.5\.[6789]/);
});
