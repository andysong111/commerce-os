...
export type PreparedSeoShoplingDirectApply = ReturnType<
  typeof buildKeywordShoplingDirectApplyDispatch
> & {
  plan: ReturnType<typeof buildSeoShoplingDirectPlan>;
};

export function prepareSeoShoplingDirectApply(
  items: unknown,
...
export async function dispatchPreparedSeoShoplingDirectApply(
  prepared: PreparedSeoShoplingDirectApply,
) {
