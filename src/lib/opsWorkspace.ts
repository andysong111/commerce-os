...
export const OPS_WORKSPACE_GROUPS: readonly OpsWorkspaceGroup[] = [
  ...
  },
  {
    ...
    shortLabel: "상품·출시",
    iconLabel: "출",
    description: "상품 마스터부터 신규 상품 준비, 샵플링 등록까지 출시 작업을 연결합니다.",
    moduleIds: [
      "product-master",
    ...
    searchTerms: ["상품", "모델번호", "신규", "출시", "등록", "업로드", "샵플링"],
  },
  {
    id: "content-keyword",
    label: "콘텐츠·키워드",
...
const COMMAND_INTENTS: readonly (OpsCommandIntent & { patterns: readonly RegExp[] })[] = [
  ...
  },
  {
    ...
    moduleIds: ["product-launch-tracker", "product-launch-flow", "shopling-product-upload-runner"],
