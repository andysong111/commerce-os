...
export function getSeoShoplingLiveReadiness(): SeoShoplingLiveReadiness {
  ...
  if (process.env.KEYWORD_SHOPLING_APPLY_ENABLED?.trim() === "1") configured.push("KEYWORD_SHOPLING_APPLY_ENABLED=1");
  else missing.push("KEYWORD_SHOPLING_APPLY_ENABLED=1");
