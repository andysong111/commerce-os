...
export const moduleRegistry: readonly CommerceModule[] = [
  ...
  {
    id: "detail-page-ai-review",
    title: "상세페이지 AI 작업 검수",
    navigationLabel: "상세페이지 AI 작업 검수",
    description:
      "신규상품출시관리의 상세페이지 생성 작업을 한눈에 보고, 문제 이미지·검수 사유·1688 원본을 비교해 문제 자산만 이어서 재생성합니다.",
    status: "available",
    route: "/detail-page-ai-review",
    category: "detail-page",
    inputType: "내부 상품출시진행관리 상세페이지 생성·AI 검수 이력",
    outputType: "작업별 이미지 미리보기, 검수 판정, 문제 자산 부분 재생성, 전체 재생성",
    historySupport: true,
    externalProject: false,
    note: "최근 50개 작업과 저장된 체크포인트를 사용합니다. 부분 재생성은 정상 상세 섹션과 승인 이미지를 보존합니다.",
    helperNote: "문제 이미지 확대·부분 재생성",
    actionLabel: "검수·재생성 열기",
    safetyBadge: "정상 자산 보존",
  },
  {
