...
export const detailPageSaasTestModule: CommerceModule = {
  ...
  note: "기준 버전 v260807. commerce-os-detail-page-studio의 OPS 전용 main/isolated-ops-center 코드선을 기존 Studio Production에 승격해 사용합니다. SaaS 전용·SaaS 테스트버전은 각각 별도 isolated 브랜치 배포를 사용하므로 엔진 코드 수정은 자동 반영되지 않습니다.",
  helperNote: "v260807 · OPS Center 전용 · 독립 엔진 코드선",
