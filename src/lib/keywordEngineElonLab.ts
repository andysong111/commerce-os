...
export const KEYWORD_ENGINE_ELON_LAB_STAGES: readonly KeywordEngineElonLabStage[] = [
  ...
  { index: 4, key: "probe_generation", title: "상품 정체성 구조화 · Probe 생성", input: "정제 seed", output: "core_product, identity_anchor, 역할별 수식어, Primary/Conditional/Blocked Probe", purpose: "공백 단위 분해를 버리고 상품 자체·기능·디자인·스펙·옵션을 먼저 구분한 뒤 의미 있는 탐색 질의만 만듭니다.", implemented: true },
  { index: 5, key: "related_query_collection", title: "연관검색어 수집", input: "Primary + Conditional Probe", output: "네이버 자동완성/연관 후보와 출처", purpose: "상품 정체성을 보존한 Probe 주변의 실제 검색 언어 후보를 확보합니다.", implemented: false },
