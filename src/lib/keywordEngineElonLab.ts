...
export const KEYWORD_ENGINE_ELON_LAB_STAGES: readonly KeywordEngineElonLabStage[] = [
  ...
  { index: 2, key: "seed_selection", title: "Seed 결정", input: "Shopling 상품 Context", output: "선택된 seed와 선택 근거", purpose: "상품명·모델명 중 어떤 값을 키워드 탐색의 원점으로 삼을지 검수합니다.", implemented: false },
...
export const KEYWORD_ENGINE_ELON_LAB_CURRENT_IMPLEMENTED_STAGE = 1;
