...
import { PreviousPurchaseCycleHandoff } from "@/components/fast-purchase-mvp/PreviousPurchaseCycleHandoff";
...
export default async function FastPurchaseMvpPage() {
  ...
  const [report, previousCycleHandoff] = await Promise.all([
    loadFastPurchaseMvpResilient(),
    loadInternalChinaPurchaseCycleHandoff(currentCycleMonth),
  ]);
  ...
  return (
    <div className="space-y-6">
      ...
      <PreviousPurchaseCycleHandoff handoff={previousCycleHandoff} />
