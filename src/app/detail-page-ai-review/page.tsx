...
import { DetailPageJobListRequestCoalescer } from "@/components/detail-page-ai-review/DetailPageJobListRequestCoalescer";
...
export default function DetailPageAiReviewPage() {
  return (
    <>
      <DetailPageJobListRequestCoalescer />
      <PageHeader
      ...
      <div className="mb-5 flex flex-wrap gap-2 text-xs font-bold text-slate-600">
        <span className="rounded-full bg-blue-50 px-3 py-1.5 text-blue-700">화면 자동갱신 · Job 목록 서버조회 10초 공유</span>
