...
import { ShoplingPriceModifyJobDiagnostics } from "@/components/shopling-price-modify-runner/ShoplingPriceModifyJobDiagnostics";
...
export default function ShoplingPriceModifyRunnerPage() {
  return <>
    ...
    />
    <ShoplingPriceModifyJobDiagnostics />
