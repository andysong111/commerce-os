  ...
  return (
    <div className="space-y-5">
      <PageHeader
        ...
        title="재고·품절·재입고 동기화"
        description="B코드 품절을 실제로 확인한 순간 재고를 0으로 초기화합니다. 이후 확정입고와 Canonical 판매로 Commerce OS 정확재고를 이어가며, Shopling/마켓에는 재고수량이 아니라 품절·판매중 상태만 전송합니다. Shopling은 A4·A6·A21 작업화면을 각각 탭으로 열어둔 상태에서 실행하며, v0.2.1부터 가격조정 확장의 all-frame 탐색·작업탭 새로고침·동적 worker 주입 방식을 재사용합니다."
        actions={
          <Link
